    ...
    return {
      damessageReminding: [
        {
          ...
          type: "radio",
          prop: "sendReminder",
          value: ""|| storage.get('sendReminder'),
          options: [
            { label: "开启", value: 1 },
            { label: "关闭", value: 0 }
          ]
      ...
      payWay: [
        ...
        },
        {
          ...
          type: "select",
          prop: "norealBuckle",
          value: storage.get('norealBuckle'),
          options: [
            { label: "周扣", value:1 },
            { label: "月扣", value:0 }
          ]
      ...
      finance: [
        {
          ...
          type: "radio",
          prop: "autoTransfer",
          value: storage.get('autoTransfer'),
          options: [{ label: "是", value: 1 }, { label: "否", value: 0 }]
        },
        {
          title: "转账日期",
          type: "radio",
          prop: "transferDate",
          value: storage.get('transferDate'),
          options: [
            { label: "每日", value: 0 },
            { label: "每周", value: 1 },
            { label: "每月", value: 2 },
        ...
        },
        {
          ...
          type: "datetime",
          prop: "transferTime",
          value: storage.get('transferTime')
        }
      ],
      taxParameters: [
        {
        ...
        },
        {
          ...
          type: "input",
          prop: " dutyParagraph",
          value: storage.get('dutyParagraph'),
