 ...
 return {
  //  showData:true,
   ...
   detailsFormData:[
     ...
     {title: '试玩渠道', type:"cascader-multiple", prop: 'channel',options:[{label:'10001',value:''},{label:'10002',value:''}]},
     ...
     {title: '试玩终端', type:"select-multiple", prop: 'terminal',option:[{label:'SC001',value:''},{label:'SC002',value:''}]},
     {title: '结束试玩时间', type: 'datepicker', prop: 'endTime', value: '', option:['start', 'end']},
     {title: '试玩区域', type:"cascader-multiple", prop: 'area',option:[{label:'广东',value:''},{label:'深圳',value:''}]},
   ],
    //游戏规则
   ruleFormData:[
