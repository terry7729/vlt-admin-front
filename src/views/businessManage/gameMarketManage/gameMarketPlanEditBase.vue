...
export default {
  ...
  data() {
    return {
      baseData: [
        {title: '上市计划名称', type: 'input',  prop: 'name', value: '', placeholder: '请输入上市计划名称'},
        {title: '上市时间', type: 'datetime-range',  prop: '', value: '', options:['start', 'end']},
        {title: '计划简介', type: 'textarea',  prop: 'desc', value: '', placeholder: '请输入上市计划简介'},
        {title: '上市游戏', type: 'select',  prop: 'developersName', value: '', options:[{label: '网易',value: '0'},{label: '腾讯',value: '1'},{label: '盛大',value: '2'}]},
