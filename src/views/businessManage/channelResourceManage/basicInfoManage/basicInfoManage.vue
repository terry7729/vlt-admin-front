        ...
        <el-table :data="typeData" border style="width: 100%">
          ...
          <el-table-column label="操作" width="120">
            <template slot-scope="scope">
              ...
              <el-button @click="typeAmend(scope.row.id,scope.row.goodsType)" type="primary" v-prevent="2000" size="mini">修改</el-button>
            </template>
          </el-table-column>
        </el-table>
        <table-paging position="right" :total="typeTotalCount" :currentPage="typeCurrentPage" :pageSize="pageSize"
