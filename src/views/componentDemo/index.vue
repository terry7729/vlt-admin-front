      ...
      <div class="vlt-edit-double">
        ...
        <div class="vlt-edit-wrap">
          <el-form
            ...
            ref="form"
          >
            <base-form :formData="data1" ref="baseForm" labelWidth="140px" :rules="rules1" direction="top" @change="changeForm"></base-form>
      ...
      <div class="vlt-edit-over">
        ...
        <div class="vlt-edit-wrap">
          <el-form
            ...
            ref="form"
          >
            <base-form :formData="data1" labelWidth="140px" ref="baseForm" :rules="rules1" direction="top" @change="changeForm"></base-form>
          </el-form>
          <el-row class="vlt-edit-btn">
            <el-button type="primary" v-prevent="1000" size="medium" @click="submit">提交并保存</el-button>
            <el-button size="medium" @click="cancel">取消</el-button>
  ...
  data() {
    ...
    return {
      ...
      data1: [
        ...
        {type: 'select', title: '性别', prop: 'sex', options:[{label: '男',value: '0'},{label: '女',value: '1'},]},
        {type: 'textarea', title: '备注', prop: 'remark'},
        {title: '状态', type: 'select', prop: 'status', value: '', options:[{label: '男',value: '0'},{label: '女',value: '1'},]},
        {title: '兑奖权限', type: 'switch', prop: 'isShow', value: ''},
        {title: '日期选择', type: 'datepicker', prop: 'date', value: ''},
        {title: '起止日期', type: 'datepicker-range', prop: '', value: '', options:['start', 'end']},
        {title: '起止时间', type: 'datetime-range', prop: '', value: '', options:['startTime', 'endTime']},
        {title: '兑奖权限', type: 'switch', prop: 'isShow', value: false},
        {title: '性别', type: 'select', prop: 'sex', value: {label: '女',value: '1'}, options:[{label: '男',value: '0'},{label: '女',value: '1'},]},
        {title: '单个日期选择', type: 'datepicker', prop: 'date1', value: '2019-09-12'},
        {title: '两个日期选择', type: 'datepicker-range', prop: 'date2', value: ['2019-08-12 09:10:10', '2019-09-20 12:12:12'], option: ['start', 'end']},
        {title: '单个时间', type: 'datetime', prop: 'date3', value: '2019-03-20 09:10:55'},
        {title: '两个时间', type: 'datetime-range', prop: 'date4', value: ['2019-08-12 09:10:10', '2019-09-20 12:12:12'], option: ['start', 'end']},
        {title: '渠道地址', type: 'address', prop: 'address',value:['130000','130200','130203'],address: '天安数码城'}
      ],
      data2: [
        {title: '单选',type: 'radio', prop: 'radio', value: '', options:[{key:1,value:'选项一'},{key:2,value:'选项二'}]},
        {type: 'input', title: '测试', prop: 'test'},
        {type: 'select-multiple', title: '下拉（多选）', prop: 'status', options:[{label: '男',value: '0'},{label: '女',value: '1'},]},
        {type: 'select', title: '状态', prop: 'status', options:[{label: '男',value: '0'},{label: '女',value: '1'},]},
        {type: 'textarea', title: '说明', prop: 'all'},
        {type: 'switch', title: '兑奖权限', prop: 'isShow'},
        {type: 'datepicker', prop: 'date1', value: '', title: '日期选择'},
        {type: 'datepicker-range', prop: 'date2', value: '', title: '日期选择', options: ['start', 'end']},
        {type: 'datetime', prop: 'date3', value: '', title: '日期时间'},
        {type: 'datetime-range', prop: 'date4', value: '', title: '日期时间', options: ['start', 'end']},
        {
          type: 'cascader-multiple', prop: 'cascader1', value: '', title: '级联选择（多选）', placeholder: '请选择',
          options: [
            {
              value: 'zhinan',
              label: '指南',
      ...
      searchOptions: [
        ...
        {
          title: '设备状态', type: 'select', prop: 'selectName', value: '',
          options: [
            {
              label: "选项1",
              value: 1
