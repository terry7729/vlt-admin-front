  ...
  <div class="vlt-card">
    ...
    <div>
      ...
      >
        ...
        <el-table-column align="center" prop label="告警频率" min-width="10%">
          <template slot-scope="scope">
            <el-input-number
