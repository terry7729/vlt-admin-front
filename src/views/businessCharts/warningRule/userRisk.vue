  ...
  <div class="vlt-card">
    ...
    <div>
      ...
      >
        ...
        <el-table-column align="center" prop="provinceName" label="单日投注限额"></el-table-column>
        <el-table-column align="center" prop="cityName" label="单日投注次数限制"></el-table-column>
        <el-table-column align="center" prop="highestSalesMoneyOrdinary" label="单日游戏时长限制"></el-table-column>
        <el-table-column align="center" prop="minimumSalesMoneyOrdinary" label="时间范围"></el-table-column>
