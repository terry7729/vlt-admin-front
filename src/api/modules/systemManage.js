...
export default {
  ...
  */
  ...
  //菜单详情
  QueryModuleDetail: (options, id) => ajax.post(`/module/queryModuleDetail/${id}`, options),
  //新增菜单
  ...
  //查询机构详情
  QueryInsInfo:(options,id) => ajax.post(`/ins/queryInsInfo/${id}`,options),
  //添加机构
  ...
  //部门树查询
  FindDeptTreeRoots:(options = {},id) =>ajax.post(`/dept/findDeptTreeRoots/${id}`,options),
